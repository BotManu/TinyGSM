...
#ifndef SRC_TINYGSMCLIENTEG25_H_
#define SRC_TINYGSMCLIENTEG25_H_
// #pragma message("TinyGSM:  TinyGsmClientEG25")
...
class TinyGsmEG25 : public TinyGsmModem<TinyGsmEG25>,
                    public TinyGsmGPRS<TinyGsmEG25>,
                    public TinyGsmTCP<TinyGsmEG25, TINY_GSM_MUX_COUNT>,
                    public TinyGsmCalling<TinyGsmEG25>,
                    public TinyGsmSMS<TinyGsmEG25>,
                    public TinyGsmTime<TinyGsmEG25>,
                    public TinyGsmNTP<TinyGsmEG25>,
                    public TinyGsmGPS<TinyGsmEG25>,
                    public TinyGsmBattery<TinyGsmEG25>,
                    public TinyGsmTemperature<TinyGsmEG25> {
  friend class TinyGsmModem<TinyGsmEG25>;
  friend class TinyGsmGPRS<TinyGsmEG25>;
  friend class TinyGsmTCP<TinyGsmEG25, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmCalling<TinyGsmEG25>;
  friend class TinyGsmSMS<TinyGsmEG25>;
  friend class TinyGsmTime<TinyGsmEG25>;
  friend class TinyGsmNTP<TinyGsmEG25>;
  friend class TinyGsmGPS<TinyGsmEG25>;
  friend class TinyGsmBattery<TinyGsmEG25>;
  friend class TinyGsmTemperature<TinyGsmEG25>;

  /*
   * Inner Client
   */
 public:
  class GsmClientEG25 : public GsmClient {
    friend class TinyGsmEG25;

   public:
    GsmClientEG25() {}

    explicit GsmClientEG25(TinyGsmEG25& modem, uint8_t mux = 0) {
      init(&modem, mux);
    }

    bool init(TinyGsmEG25* modem, uint8_t mux = 0) {
      this->at       = modem;
      sock_available = 0;
      prev_check     = 0;
  ...
  /*
  class GsmClientSecureEG25 : public GsmClientEG25
  {
  public:
    GsmClientSecure() {}

    GsmClientSecure(TinyGsmEG25& modem, uint8_t mux = 0)
  ...
  */
   ...
   */
 public:
  explicit TinyGsmEG25(Stream& stream) : stream(stream) {
 ...
 protected:
  bool initImpl(const char* pin = NULL) {
    ...
    DBG(GF("### TinyGSM Compiled Module:  TinyGsmClientEG25"));
 ...
 protected:
  ...
  // The EG25 returns UTC time instead of local time as other modules do in
 ...
 protected:
  GsmClientEG25* sockets[TINY_GSM_MUX_COUNT];
  const char*    gsmNL = GSM_NL;
};

#endif  // SRC_TINYGSMCLIENTEG25_H_
